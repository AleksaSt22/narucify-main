...
async def get_me(user: dict = Depends(get_current_user)):
    ...
    return {
        ...
        "shop_viber": user.get("shop_viber"),
        "shop_layout": user.get("shop_layout", "classic"),
        "shop_show_low_stock": user.get("shop_show_low_stock", False),
        "shop_show_share": user.get("shop_show_share", False),
        "shop_quick_order": user.get("shop_quick_order", False),
